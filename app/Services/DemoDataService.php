...
class DemoDataService
{
    ...
    /**
     * التوليد بيمسح الأول دايمًا.
     * أرقام المستندات (PO/SA/FI/WO…) مبنية على عدّاد متسلسل، فلو ولّدنا
     * فوق داتا موجودة هيحصل تضارب في الأرقام الفريدة، والمبيعات هتتضاعف.
     */
